    ...
    <div className="card" style={{ maxWidth: 1000, margin: '20px auto' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
          ...
          <button className="btn btn-ghost" onClick={() => window.location.href = '/admin/journals'}>Journal Admin</button>
          <button className="btn btn-ghost" onClick={() => window.location.href = '/admin/courses'}>Course Admin</button>
        </div>
      </div>
